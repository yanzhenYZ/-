...
- (void)animationGroup{
    ...
    position.toValue = [NSValue valueWithCGPoint:self.firstBtn.center];
    
    CABasicAnimation *scale = [CABasicAnimation animationWithKeyPath:@"transform"];
    scale.toValue = [NSValue valueWithCATransform3D:CATransform3DMakeScale(1.5, 1.5, 1)];
    ...
    group.duration = 2;
    [self.secondBtn.layer addAnimation:group forKey:@"Position+Scale"];
}
@end
